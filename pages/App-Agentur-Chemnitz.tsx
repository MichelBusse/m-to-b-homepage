...
export default function AppDevelopmentChemnitzPage(props: Props) {
  ...
  let texts = {
    ...
    title: "App-Entwicklung Chemnitz - App-Agentur M-to-B",
    description:
      "Dein Partner für App-Entwicklung in Chemnitz. Als digitale App-Agentur führen wir deine App-Idee mit der richtigen Strategie sicher zum Ziel.",
    textSectionHeadline: "Moderne Apps für Chemnitz",
    textSectionText: (
      <>
        <p>
          Als digitale App Agentur unterstützen wir Chemnitzer Unternehmen bei
  ...
  if (router.locale == "en") {
    texts = {
      ...
      title: "App Development Chemnitz - App Agency M-to-B",
      description:
        "Your partner for app development in Chemnitz. As a digital app agency, we guide your app idea safely to its goal with the right strategy.",
      textSectionHeadline: "Modern apps for Chemnitz",
      textSectionText: (
        <>
          <p>
            As a digital app agency, we support Chemnitz companies in realizing
  ...
  return (
    <>
      ...
      <main>
        ...
        <CustomersSection />
        <ContactSection anchorRefs={props.anchorRefs} location="Chemnitz" locationLink="/App-Agentur-Chemnitz"/>
      </main>
    </>
  );
}
