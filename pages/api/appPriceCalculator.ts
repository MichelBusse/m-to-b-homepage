...
export default async function handler(
  ...
  let mailData = {
    ...
    text:
      ...
      "Außerdem geben wir Ihnen am Ende dieser Mail noch einen Leitfaden, wie Sie den Entwicklungs-Aufwand Ihrer App etwas genauer ausarbeiten und abschätzen können.\n\n" +
    ...
    html:
      ...
      "<p>Außerdem geben wir Ihnen am Ende dieser Mail noch einen Leitfaden, wie Sie den Entwicklungs-Aufwand Ihrer App etwas genauer ausarbeiten und abschätzen können.</p>" +
