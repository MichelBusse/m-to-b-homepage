...
export default function AppDevelopmentLeipzigPage(props: Props) {
  ...
  let texts = {
    ...
    title: "App-Entwicklung Leipzig - App-Agentur M-to-B",
    description:
      "Dein Partner für App-Entwicklung in Leipzig. Als digitale App-Agentur führen wir deine App-Idee mit der richtigen Strategie sicher zum Ziel.",
    textSectionHeadline: "Moderne Apps für Leipzig",
    textSectionText: (
      <>
        <p>
          Als digitale App Agentur unterstützen wir Leipziger Unternehmen bei
  ...
  if (router.locale == "en") {
    texts = {
      ...
      title: "App Development Leipzig - App Agency M-to-B",
      description:
        "Your partner for app development in Leipzig. As a digital app agency, we guide your app idea safely to its goal with the right strategy.",
      textSectionHeadline: "Modern apps for Leipzig",
      textSectionText: (
        <>
          <p>
            As a digital app agency, we support Leipzig companies in realizing
  ...
  return (
    <>
      ...
      <main>
        ...
        <CustomersSection />
        <ContactSection anchorRefs={props.anchorRefs} location="Leipzig" locationLink="/App-Agentur-Leipzig"/>
      </main>
    </>
  );
}
