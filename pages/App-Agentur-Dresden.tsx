...
export default function AppDevelopmentDresdenPage(props: Props) {
  ...
  let texts = {
    ...
    title: "App-Entwicklung Dresden - App-Agentur M-to-B",
    description:
      "Dein Partner für App-Entwicklung in Dresden. Als digitale App-Agentur führen wir deine App-Idee mit der richtigen Strategie sicher zum Ziel.",
    textSectionHeadline: "Moderne Apps für Dresden",
    textSectionText: (
      <>
        <p>
          Als digitale App Agentur unterstützen wir Dresdener Unternehmen bei
  ...
  if (router.locale == "en") {
    texts = {
      ...
      title: "App Development Dresden - App Agency M-to-B",
      description:
        "Your partner for app development in Dresden. As a digital app agency, we guide your app idea safely to its goal with the right strategy.",
      textSectionHeadline: "Modern apps for Dresden",
      textSectionText: (
        <>
          <p>
            As a digital app agency, we support Dresden companies in realizing
    ...
    <>
      <Head>
        <link
          rel="alternate"
          hrefLang="de"
          href="https://m-to-b.com/App-Agentur-Dresden"
        />
        <link
          rel="alternate"
          hrefLang="en"
          href="https://m-to-b.com/en/App-Agentur-Dresden"
        />
      ...
      <main>
        ...
        <CustomersSection />
        <ContactSection anchorRefs={props.anchorRefs} location="Dresden" locationLink="/App-Agentur-Dresden"/>
      </main>
    </>
  );
}
