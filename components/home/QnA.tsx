...
export default function QnA(props : Props) {
  ...
  let texts = {
    ...
    answer1:
      "Eine pauschale Kostenbeschreibung vorab zu nennen ist in der App-Entwicklung praktisch unmöglich. In der Regel setzen wir uns mit Ihnen zusammen und besprechen Ihre Vorstellungen, die gewünschten Funktionen, die Ziele und dein Budget. Dazu beraten wir Sie zu den verschiedenen Möglichkeiten für das Projekt und geben unsere Empfehlungen. Danach entscheiden Sie, ob Sie Ihre App mit uns realisieren möchtest.",
    question2: "Wie lange dauert die Entwicklung einer App?",
    answer2:
      "Für die zeitliche Einordnung und einen Überblick über den aktuellen Entwicklungsstand setzen wir auf häufige Kundenkommunikation. Sie erfahren im wöchentlichen Abstand, wie weit die Entwicklung Ihrer App gerade ist und welche zeitlichen Risiken es noch gibt. So schaffen wir einen transparenten und nachvollziehbaren Arbeitsablauf.",
    question3: "Was passiert nach der Fertigstellung?",
    answer3:
      "Sobald Ihre App alle Features fertig enthält, Sie mit dem Ergebnis zufrieden sind und das Projekt abgenommen ist, kann es je nach Vereinbarung unterschiedlich weitergehen. Entweder übergeben wir die App komplett an Sie, oder begleiten sie beim weiteren Prozess, wie z.B. dem Upload in den App-Store, der Live-Schaltung oder der Wartung.",
