...
export default function QnA(props: Props) {
  ...
  let texts = {
    ...
    answer1: (
      <>
        Eine pauschale Kostenbeschreibung vorab zu nennen ist in der App
        Entwicklung schwierig. In der Regel setzen wir uns mit Ihnen zusammen
        und besprechen Ihre Vorstellungen, die gewünschten Funktionen, die Ziele
        und dein Budget. Um eine Vorstellung für dein Budget vorab zu bekommen,
        kannst du unseren{" "}
    ...
    answer2: (
      <>
        ...
        Entwicklungsstand setzen wir auf häufige Kundenkommunikation. Sie
        erfahren im wöchentlichen Abstand, wie weit die Entwicklung Ihrer App
        gerade ist und welche zeitlichen Risiken es noch gibt. So schaffen wir
        einen transparenten und nachvollziehbaren Arbeitsablauf.
      </>
    ),
    question3: "Was passiert nach der Fertigstellung?",
    answer3: (
      <>
        Sobald Ihre App alle Features fertig enthält, Sie mit dem Ergebnis
        zufrieden sind und das Projekt abgenommen ist, kann es je nach
        Vereinbarung unterschiedlich weitergehen. Entweder übergeben wir die App
        komplett an Sie, oder begleiten sie beim weiteren Prozess, wie z.B. dem
        Upload in den App-Store, der Live-Schaltung oder der Wartung.
      </>
    ),
