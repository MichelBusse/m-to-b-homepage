...
export default function AppDevelopmentJenaPage(props: Props) {
  ...
  let texts = {
    ...
    title: "App-Entwicklung Jena - App-Agentur M-to-B",
    description:
      "Dein Partner für App-Entwicklung in Jena. Als digitale App-Agentur führen wir deine App-Idee mit der richtigen Strategie sicher zum Ziel.",
    textSectionHeadline: "Moderne Apps für Jena",
    textSectionText: (
      <>
        <p>
          Als digitale App Agentur unterstützen wir Jenaer Unternehmen bei
  ...
  if (router.locale == "en") {
    texts = {
      ...
      title: "App Development Jena - App Agency M-to-B",
      description:
        "Your partner for app development in Jena. As a digital app agency, we guide your app idea safely to its goal with the right strategy.",
      textSectionHeadline: "Modern apps for Jena",
      textSectionText: (
        <>
          <p>
            As a digital app agency, we support Jena companies in realizing
    ...
    <>
      <Head>
        <link
          rel="alternate"
          hrefLang="de"
          href="https://m-to-b.com/App-Agentur-Jena"
        />
        <link
          rel="alternate"
          hrefLang="en"
          href="https://m-to-b.com/en/App-Agentur-Jena"
        />
      ...
      <main>
        ...
        <CustomersSection />
        <ContactSection anchorRefs={props.anchorRefs} location="Jena" locationLink="/App-Agentur-Jena"/>
      </main>
    </>
  );
}
