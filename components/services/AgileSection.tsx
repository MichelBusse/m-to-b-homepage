      ...
      <section className={styles.agileSection}>
        ...
        >
          ...
          >
            ...
            <path className={styles.arrowText} d="M290.2,163.3l-4.1,4.1l11.4,11.4l-1.7,1.7l-11.4-11.4l-4.1,4.1l-1.4-1.4l9.9-9.9L290.2,163.3z"/>
		<path className={styles.arrowText} d="M306.5,170.2c-1.3,1.3-2.8,1.9-4.4,1.9c-1.7,0-3.2-0.8-4.6-2.2l-0.3-0.3c-0.9-0.9-1.6-2-2-3.1
		...
		<path className={styles.arrowText} d="M314.9,156.4c-0.4-0.4-0.9-0.6-1.5-0.5c-0.6,0.1-1.4,0.5-2.4,1.1c-1,0.6-1.9,1.1-2.6,1.3
		...
		<path className={styles.arrowText} d="M311.6,141.1l2.3,2.3l1.8-1.8l1.3,1.3l-1.8,1.8l5.9,5.9c0.4,0.4,0.7,0.6,1.1,0.6c0.3,0,0.7-0.1,1.1-0.5
			c0.2-0.2,0.4-0.5,0.7-0.9l1.3,1.3c-0.3,0.5-0.7,1-1.1,1.4c-0.7,0.7-1.5,1.1-2.3,1c-0.8-0.1-1.6-0.5-2.4-1.3l-5.9-5.9l-1.7,1.7
          ...
          >
            ...
            <g style={router.locale !== "en" ? { display: "none" } : {}}>
            <path className={styles.arrowText} d="M509.3,420.6l-12.8-12.8l3.6-3.6c1.1-1.1,2.3-1.8,3.7-2.2c1.3-0.4,2.7-0.3,4.1,0.1c1.4,0.4,2.7,1.2,3.8,2.4
		...
		<path className={styles.arrowText} d="M525,405.3c-1.3,1.3-2.8,1.9-4.4,1.9c-1.7,0-3.2-0.8-4.6-2.2l-0.3-0.3c-0.9-0.9-1.6-2-2-3.1
			c-0.4-1.1-0.5-2.2-0.2-3.3c0.2-1.1,0.7-2,1.5-2.7c1.2-1.2,2.6-1.8,4.1-1.7c1.5,0.1,3,1,4.5,2.5l0.7,0.7l-6.4,6.4
			c1,0.9,2,1.4,3.1,1.4c1.1,0.1,2.1-0.3,2.9-1.1c0.6-0.6,0.9-1.2,1.1-1.8c0.2-0.6,0.2-1.3,0.1-2l1.8-0.2
		...
		<path className={styles.arrowText} d="M533.4,391.4c-0.4-0.4-0.9-0.6-1.5-0.5c-0.6,0.1-1.4,0.5-2.4,1.1c-1,0.6-1.9,1.1-2.6,1.3
			c-0.7,0.2-1.4,0.3-2,0.2s-1.1-0.4-1.6-0.9c-0.8-0.8-1.1-1.8-1-3c0.1-1.2,0.7-2.3,1.7-3.3c1.1-1.1,2.2-1.7,3.5-1.8
			c1.2-0.1,2.3,0.3,3.1,1.1l-1.6,1.6c-0.4-0.4-1-0.6-1.7-0.6c-0.7,0.1-1.3,0.4-1.9,0.9c-0.6,0.6-0.9,1.2-1,1.8
			c-0.1,0.6,0.1,1.1,0.5,1.5c0.4,0.4,0.8,0.5,1.4,0.4c0.5-0.1,1.3-0.5,2.3-1.1c1-0.6,1.9-1.1,2.6-1.3c0.8-0.3,1.4-0.3,2-0.2
		...
		<path className={styles.arrowText} d="M527.6,378.2c-0.3-0.3-0.4-0.6-0.4-0.9c0-0.3,0.1-0.7,0.4-1s0.6-0.5,1-0.4c0.3,0,0.6,0.2,0.9,0.4
		...
		<path className={styles.arrowText} d="M538.8,381.4c-1.5-1.5-2.3-3-2.5-4.6c-0.2-1.6,0.3-2.9,1.4-4c1.2-1.2,2.5-1.7,3.9-1.5l-1-1.1l1.5-1.5l9.3,9.3
		...
		<path className={styles.arrowText} d="M546.1,364.7l1.2,1.1c-0.2-1.6,0.3-3,1.5-4.2c2-2,4.2-1.9,6.4,0.4l6.3,6.3l-1.6,1.6l-6.3-6.3
          ...
          >
            ...
            <g style={router.locale !== "en" ? { display: "none" } : {}}>
            <path className={styles.arrowText} d="M480.8,129.3l-1.7-1.7l12.8-12.8l1.7,1.7L480.8,129.3z"/>
		<path className={styles.arrowText} d="M494.7,124.2l-1,1.1c1.5-0.1,2.9,0.4,4,1.6c1.3,1.3,1.7,2.7,1.2,4.2c0.8-0.1,1.6-0.1,2.3,0.1
		...
		<path className={styles.arrowText} d="M512.1,151.3c-1.4,1.4-2.9,2.3-4.5,2.5c-1.5,0.2-2.9-0.2-4-1.4c-1.2-1.2-1.7-2.4-1.6-3.8l-4.6,4.6l-1.6-1.6
		...
		<path className={styles.arrowText} d="M511.3,159.8l-1.6-1.6l13.5-13.5l1.6,1.6L511.3,159.8z"/>
		<path className={styles.arrowText} d="M517.6,166.5c-1.3-1.3-1.9-2.8-1.9-4.4s0.8-3.2,2.2-4.6l0.3-0.3c0.9-0.9,2-1.6,3.1-2c1.1-0.4,2.2-0.5,3.2-0.2
		...
		<path className={styles.arrowText} d="M534.4,163.9l-1,1.1c1.5-0.1,2.9,0.4,4,1.6c1.3,1.3,1.7,2.7,1.2,4.2c0.8-0.1,1.6-0.1,2.3,0.1
		...
		<path className={styles.arrowText} d="M542.9,191.8c-1.3-1.3-1.9-2.8-1.9-4.4c0-1.7,0.8-3.2,2.2-4.6l0.3-0.3c0.9-0.9,2-1.6,3.1-2
		...
		<path className={styles.arrowText} d="M559.7,189.2l-1.1,1.2c1.6-0.2,3,0.3,4.2,1.5c2,2,1.9,4.2-0.4,6.4l-6.3,6.3l-1.6-1.6l6.3-6.3
			c0.7-0.7,1-1.4,1-2c0-0.6-0.3-1.3-0.9-1.9c-0.5-0.5-1.1-0.9-1.8-1s-1.4-0.1-2,0.2l-6.8,6.8l-1.6-1.6l9.5-9.5L559.7,189.2z"/>
		<path className={styles.arrowText} d="M572.6,197.5l-2.3,2.3l1.8,1.8l-1.3,1.3l-1.8-1.8l-5.9,5.9c-0.4,0.4-0.6,0.7-0.6,1.1c0,0.3,0.1,0.7,0.5,1.1
			c0.2,0.2,0.5,0.4,0.9,0.7l-1.3,1.3c-0.5-0.3-1-0.7-1.4-1.1c-0.7-0.7-1.1-1.5-1-2.3c0.1-0.8,0.5-1.6,1.3-2.4l5.9-5.9l-1.7-1.7
          ...
          >
            ...
            <g style={router.locale !== "en" ? { display: "none" } : {}}>
            <path className={styles.arrowText} d="M276.6,368.4l-3-3l-5.2,5.2l-1.7-1.7l12.8-12.8l4.2,4.2c1.4,1.4,2.2,2.9,2.3,4.3c0.1,1.4-0.4,2.8-1.7,4
		...
		<path className={styles.arrowText} d="M281.4,383.8c-1.3-1.3-1.9-2.8-1.9-4.4s0.8-3.2,2.2-4.6l0.3-0.3c0.9-0.9,2-1.6,3.1-2c1.1-0.4,2.2-0.5,3.3-0.2
			c1.1,0.2,2,0.7,2.7,1.5c1.2,1.2,1.8,2.6,1.7,4.1c-0.1,1.5-1,3-2.5,4.5l-0.7,0.7l-6.4-6.4c-0.9,1-1.4,2-1.5,3.1
			...
			/>
		<path className={styles.arrowText} d="M292.4,390l9.7-4.9l1.7,1.7l-12.9,6.1l-1.2-1.2l6.1-12.9l1.7,1.7L292.4,390z"/>
		<path className={styles.arrowText} d="M297.5,399.6l-1.6-1.6l9.5-9.5l1.6,1.6L297.5,399.6z M307.8,385.8c0.3-0.3,0.6-0.4,0.9-0.4
		...
		<path className={styles.arrowText} d="M303.9,406.3c-1.3-1.3-1.9-2.8-1.9-4.4c0-1.7,0.8-3.2,2.2-4.6l0.3-0.3c0.9-0.9,2-1.6,3.1-2
			c1.1-0.4,2.2-0.5,3.3-0.2c1.1,0.2,2,0.7,2.7,1.5c1.2,1.2,1.8,2.6,1.7,4.1c-0.1,1.5-1,3-2.5,4.5l-0.7,0.7l-6.4-6.4
		...
		<path className={styles.arrowText} d="M320.3,417.9l9.1-5.4l1.6,1.6l-12.3,6.7l-1.3-1.3l4.9-9.5l-9.5,5l-1.3-1.3l6.7-12.3l1.6,1.6l-5.2,9l9.3-4.9
          ...
          >
            ...
            <g style={router.locale !== "en" ? { display: "none" } : {}}>
            <path className={styles.arrowText} d="M128.8,440.7v7.1h-2.4v-18.1h6.7c2,0,3.5,0.5,4.7,1.5c1.1,1,1.7,2.3,1.7,4c0,1.8-0.5,3.1-1.6,4.1
		...
		<path className={styles.arrowText} d="M144.6,447.8h-2.3v-19.1h2.3V447.8z"/>
		<path className={styles.arrowText} d="M156.6,447.8c-0.1-0.3-0.2-0.7-0.3-1.4c-1.1,1.1-2.3,1.7-3.8,1.7c-1.3,0-2.4-0.4-3.3-1.1
		...
		<path className={styles.arrowText} d="M164.3,434.3l0.1,1.7c1-1.3,2.4-1.9,4-1.9c2.8,0,4.3,1.6,4.3,4.8v8.9h-2.3v-8.9c0-1-0.2-1.7-0.7-2.1
          ...
          >
            ...
            <g style={router.locale !== "en" ? { display: "none" } : {}}>
            <path className={styles.arrowText} d="M656.5,439.7c-2-0.6-3.5-1.3-4.5-2.2c-0.9-0.9-1.4-1.9-1.4-3.2c0-1.4,0.6-2.6,1.7-3.5
		...
		<path className={styles.arrowText} d="M674.2,446.5c-0.9,1.1-2.2,1.6-3.9,1.6c-1.4,0-2.5-0.4-3.3-1.2c-0.8-0.8-1.1-2.1-1.1-3.7v-8.7h2.3v8.7
			c0,2,0.8,3.1,2.5,3.1c1.8,0,2.9-0.7,3.5-2v-9.8h2.3v13.4h-2.2L674.2,446.5z"/>
		<path className={styles.arrowText} d="M691.3,441.2c0,2-0.5,3.7-1.4,4.9c-0.9,1.3-2.2,1.9-3.8,1.9c-1.6,0-2.9-0.5-3.9-1.6v6.5H680v-18.6h2.1
			...
			"/>
		<path className={styles.arrowText} d="M705.6,441.2c0,2-0.5,3.7-1.4,4.9c-0.9,1.3-2.2,1.9-3.8,1.9c-1.6,0-2.9-0.5-3.9-1.6v6.5h-2.3v-18.6h2.1
		...
		<path className={styles.arrowText} d="M707.9,440.9c0-1.3,0.3-2.5,0.8-3.6c0.5-1.1,1.2-1.9,2.2-2.4c0.9-0.6,2-0.9,3.2-0.9c1.8,0,3.3,0.6,4.4,1.9
			...
			/>
		<path className={styles.arrowText} d="M729.5,436.4c-0.3-0.1-0.7-0.1-1.1-0.1c-1.5,0-2.5,0.6-3.1,1.9v9.5H723v-13.4h2.2l0,1.6
			c0.8-1.2,1.8-1.8,3.2-1.8c0.4,0,0.8,0.1,1,0.2V436.4z"/>
		<path className={styles.arrowText} d="M735.4,431.1v3.3h2.5v1.8h-2.5v8.3c0,0.5,0.1,0.9,0.3,1.2c0.2,0.3,0.6,0.4,1.1,0.4c0.3,0,0.6,0,1.1-0.1v1.9
