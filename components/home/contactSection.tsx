...
export default function ContactSection(props) {
    ...
    const handleSubmit = (e) => {
        ...
        if(formState.name.trim() === "" || formState.email.trim() === "" || formState.text.trim() === "" || !formState.privacy){
            ...
            <div className={styles.flexWrapper}>
                <div className={styles.contactText}>
                    <div className={styles.textWrapper}>
                        <h2>Kontakt</h2>
                        <p>Interessiert? Lassen Sie sich kostenlos zu allen Möglichkeiten für Ihr Projekt beraten und ein unverbindliches Angebot erstellen!</p>
                        <p><HiMail className={styles.icon} /><a href="mailto: kontakt@m-to-b.com">kontakt@m-to-b.com</a></p>
                        <p><BsTelephoneFill className={styles.icon} /><a href="tel:+4916098709043">0160 98709043</a></p>
                        <p><IoLocationSharp className={styles.icon} /><strong>Leipzig</strong></p>
                    </div>
                </div>
