...
export default function AppDevelopmentErfurtPage(props: Props) {
  ...
  let texts = {
    ...
    title: "App Entwicklung für Erfurt - App Agentur M-to-B",
    description:
      "Wir entwickeln Apps für Erfurter Unternehmen. Nutze unsere kostenlose Beratung und lass uns deine App verwirklichen!",
    headlineSection1: "Innovation für Erfurt",
    textSection1: (
      <>
        <p style={{ transitionDelay: "0.3s" }} key={1}>
          App-Entwicklung kann kompliziert sein - muss sie aber nicht! Wir haben
          M&#8209;to&#8209;B 2020 in Zwickau, in der Nähe von Erfurt gegründet,
          um Unternehmen bei der Verwirklichung ihrer Projekte zu unterstützen.
        </p>
        ...
        <p style={{ transitionDelay: "0.9s" }} key={3}>
          Wir begleiten Unternehmen aus Erfurt bei der Realisierung ihrer App
  ...
  if (router.locale == "en") {
    texts = {
      headline: <>App Development for Erfurt</>,
      text: (
        <>
          <p>
      ...
      title: "App Development for Erfurt - M-to-B",
      description:
        "Use our free consultation and let us make your app a reality! We develop apps for enterprises and start ups from Erfurt.",
      headlineSection1: "Innovation for Erfurt",
      textSection1: (
        <>
          <p style={{ transitionDelay: "0.3s" }} key={1}>
            App development can be complicated - but it doesn't have to be! We
            founded M&#8209;to&#8209;B 2020 in Zwickau, very close to Erfurt,
          ...
          <p style={{ transitionDelay: "0.9s" }} key={3}>
            We accompany companies from Erfurt in the realization of their app
    ...
    <>
      <Head>
        <link
          rel="alternate"
          hrefLang="de"
          href="https://m-to-b.com/App-Entwicklung-Erfurt"
        />
        <link
          rel="alternate"
          hrefLang="en"
          href="https://m-to-b.com/en/App-Entwicklung-Erfurt"
        />
